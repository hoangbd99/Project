<%-- 
    Document   : doubleroom
    Created on : 19-07-2020, 17:08:37
    Author     : GL552VW
--%>
        ...
        <div>          
            ...
            <div class="row ">
                <div class="col-sm-2" style="margin-left: 700px; text-align: center;padding-top: 100px;">
                    <h3 style="color: #955851">Phòng Đôi </h3>
            ...
            <div id="carouselExampleIndicators" class="carousel slide mt-4" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="images/501.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="images/502.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="images/504.jpg" alt="Third slide">
                    </div>
                </div>
            ...
            <div class="wpb_wrapper">
               Phòng Đôi với thiết kế hài hòa, nội thất sang trọng với đầy đủ tiện nghi hiện đại. Diện tích khoảng  50m<sup>2</sup> mỗi phòng đều được trang bị cửa sổ và ban công mang lại không gian thoáng mát, thoải mái nhất cho quý khách.<br />
                ...
                <table border="0" cellpadding="8" cellspacing="0" style="width:100%">
                    <tbody>
                        <tr>
                            <td style="width:50%">
                                <ul>
                                    <li>Diện t&iacute;ch: 50-65m<sup>2</sup></li>
